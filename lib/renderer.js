...
Renderer.prototype.code = function(code, lang, escaped) {
  // console.log('kramed: render code!');
...
Renderer.prototype.math = function(content, language, display) {
  ...
  return '<script type="' + language + mode + '">' + content.replace(/</g,'&lt;').replace(/>/g,'&gt;') + '</script>';
};
...
Renderer.prototype.label = function(labelText) {
  return `<span class="label">${labelText.trim()}</span>`;
};
