...
``` bash
npm install kramed-essence --save
```
...
Marked: Copyright (c) 2011-2014, Christopher Jeffrey. (MIT Licensed)

Kramed: Copyright (c) 2014, Aaron O'Mullan. (MIT Licensed)

Kramed Essence: Copyright (c) 2021, Sshwy. (GPL-3.0-or-later Licensed)
